...
public class CLIRunActionOMERO {
    ...
    public static void autoCropOmero(String inputDirectory, String outputDirectory, Client client, AutoCropCalling autoCrop) throws Exception {
    ...
    public void segmentationOmero(String inputDirectory, String outputDirectory, Client client, SegmentationCalling otsuModif)  throws Exception
    {
        String[] param = inputDirectory.split("/");
